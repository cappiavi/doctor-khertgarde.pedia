...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Khert Laguna Garde — Aspiring Physician & Future Pediatrician" },
      { name: "description", content: "Portfolio of Khert Laguna Garde: aspiring medical doctor pursuing pediatrics, integrating healthcare, technology, cybersecurity, and research." },
      { name: "author", content: "Khert Laguna Garde" },
      { property: "og:title", content: "Khert Laguna Garde — Aspiring Physician & Future Pediatrician" },
      { property: "og:description", content: "Aspiring medical doctor bridging pediatrics, healthcare innovation, cybersecurity, and research." },
